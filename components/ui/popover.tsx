...
function PopoverTitle({ className, ...props }: React.ComponentProps<"h2">) {
  return (
    <h2
      ...
      className={cn("text-xs font-semibold uppercase tracking-[0.18em] font-pixel text-foreground", className)}
      {...props}
    />
  )
}
