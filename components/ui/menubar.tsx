...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "hover:bg-muted aria-expanded:bg-muted flex items-center rounded-sm px-2 py-1 text-xs font-semibold text-foreground font-pixel tracking-[0.1em] outline-hidden select-none",
        className
      )}
      {...props}
    />
...
function MenubarLabel({
  ...
  return (
    <MenubarPrimitive.Label
      ...
      data-inset={inset}
      className={cn("px-2 py-1.5 text-xs font-semibold uppercase tracking-[0.14em] font-pixel text-muted-foreground data-[inset]:pl-8", className)}
      {...props}
    />
  )
}
...
function MenubarSubTrigger({
  ...
  return (
    <MenubarPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground gap-2 rounded-sm px-2 py-1.5 text-sm data-[inset]:pl-8 [&_svg:not([class*='size-'])]:size-4 flex cursor-default items-center outline-hidden select-none",
        className
      )}
      {...props}
    >
