        ...
        <CardContent className="flex flex-col gap-6 p-6 sm:p-8 md:flex-row md:items-center md:justify-between">
          <div className="space-y-2 md:max-w-sm">
            ...
            <h2 className="text-2xl font-semibold text-foreground">
              Get fresh Prism notes via email
            </h2>
            <p className="text-base leading-7 text-muted-foreground">
              When we publish new experiments or playbooks, we’ll send you the
              highlights so you can apply them faster.
            </p>
          </div>
          <form
            id="blog_updates"
          ...
          >
            <FormspreeOpsFields formKey="blog_email_signup" />
