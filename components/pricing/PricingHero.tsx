        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-24 sm:py-32">
          <RevealOnScroll delay={0.1}>
            <div className="space-y-6">
              <h1 className="text-5xl font-semibold leading-tight tracking-tight sm:text-6xl lg:text-7xl">
                clear pricing. two proven paths.
              </h1>
              <div className="space-y-2">
                <p className="text-lg text-muted-foreground sm:text-xl">
                  Choose a $1,000 website overhaul or a $2,000/month growth partnership.
                </p>
                <p className="text-sm text-muted-foreground sm:text-base">
                  Start with the free audit if you want expert guidance before committing.
                </p>
              </div>
            </div>
          </RevealOnScroll>
          <RevealOnScroll delay={0.2}>
            <div className="flex flex-col gap-3 sm:flex-row">
              <Button asChild size="lg" className="h-auto w-full rounded-md px-8 py-6 text-sm sm:w-auto">
                <a href="#plans">see pricing options</a>
              </Button>
            </div>
          </RevealOnScroll>
        ...
        >
          <div className="relative w-full max-w-6xl" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="relative aspect-video w-full overflow-hidden rounded-md border border-white/10 bg-black">
              <Image src={HERO_IMAGE.src} alt={HERO_IMAGE.alt} fill sizes="100vw" className="object-contain" priority />
            </div>
          </div>
        </div>
      ) : null}
