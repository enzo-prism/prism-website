            ...
            <div className="flex flex-col items-center space-y-6 text-center">
              <div className="space-y-3">
                <div className="flex justify-center" aria-hidden="true">
                  <PixelishIcon src="/pixelish/device-laptop.svg" alt="" size={40} invert={false} aria-hidden="true" />
                </div>
          ...
          <div className="container mx-auto px-4 md:px-6 max-w-4xl">
            <div className="bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-2xl p-8 md:p-12 text-center text-white relative overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 opacity-10" aria-hidden="true">
                <PixelishIcon src="/pixelish/device-laptop.svg" alt="" size={52} aria-hidden="true" />
              </div>
        ...
        <section className="px-4 pb-2">
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <TrackedLink
              ...
              label="open role"
              location="open_role_replit_builder"
