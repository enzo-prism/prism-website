          ...
          <div className="mb-10 rounded-md border border-border/60 bg-card/30 p-6 shadow-none backdrop-blur-sm sm:p-8">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="space-y-3 text-center sm:text-left">
                <span className="inline-flex items-center justify-center rounded-md border border-amber-400/30 bg-amber-500/10 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-amber-200 font-pixel">
                  Launch Plan
                </span>
              ...
              <div className="flex items-center gap-3 rounded-md border border-border/60 bg-card/20 px-4 py-3 text-sm text-muted-foreground shadow-none backdrop-blur-sm sm:self-start">
                <div className="flex h-8 w-8 items-center justify-center rounded-md border border-amber-400/30 bg-amber-500/10 text-amber-200 text-[10px] font-semibold font-pixel tracking-[0.16em]">
                  1:1
                </div>
