...
export async function GET(
  ...
  try {
    ...
    // Read the same MDX source used by the public blog route so new posts
    // cannot ship with a missing social image because a second slug map
    // was not updated.
    ...
    return new ImageResponse(
      <div
        style={{
          ...
          justifyContent: 'center',
          background:
            'linear-gradient(to bottom right, rgb(165, 180, 252), rgb(196, 181, 253), rgb(125, 211, 252))',
          fontSize: '32px',
          fontWeight: 700,
          color: 'rgba(0, 0, 0, 0.9)',
          textTransform: 'lowercase',
