...
export const metadata: Metadata = buildRouteMetadata({
  ...
  description:
    'We are preparing your free website and visibility analysis. Book a call if you want Prism to walk through the findings with you live.',
                ...
                <div className="flex flex-col items-center gap-4 text-center">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-base text-slate-600">
                      We’re reviewing everything and will send your report
              ...
              <RevealOnScroll>
                <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    Review your results live, ask questions, and decide on next
                    steps together.
                  </p>
                  <Button
                    asChild
