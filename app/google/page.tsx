...
const GET_STARTED_HREF = '/waitlist'
const PRICING_HREF = '/waitlist'
...
const GOOGLE_MARKETING_PLANS_HREF = '/waitlist'
...
const servicesHighlights = [
  {
    ...
    external: true,
    icon: MailCheck,
    brandLogos: ['google', 'gmail', 'googleDrive'] as const,
  },
  {
    ...
    external: false,
    icon: Globe2,
    brandLogos: ['google', 'googleAnalytics', 'youtube'] as const,
  },
  {
    ...
    external: false,
    icon: BarChart3,
    brandLogos: ['googleAnalytics'] as const,
  },
]
...
const learningLinks = [
  {
    title: 'our blog',
    description:
      'guides on google ads, business profiles, workspace, and analytics.',
    href: BLOG_HREF,
    external: false,
  },
  {
      ...
      <main className="bg-white text-neutral-900 lowercase">
                ...
                <div className="flex w-full flex-col gap-3 sm:flex-row sm:justify-start">
                  ...
                  >
                    <Link
                      ...
                      className="lowercase"
                    >
                      set up google workspace (with discount){' '}
          ...
          <div className="container mx-auto grid gap-10 px-4 py-16 md:grid-cols-[minmax(0,_320px)_1fr] md:px-6 lg:py-24">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-sm text-white/70">
                Our team helps you implement and manage the Google ecosystem in
                a way that actually drives results. Here’s how we do it:
              </p>
            </div>
                      ...
                      {service.brandLogos ? (
                        <div className="flex flex-wrap items-center gap-2">
                          {service.brandLogos.map((brand) => (
                            <span
                              key={brand}
                              className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/12 bg-white/[0.08]"
                            >
                              <BrandLogo
                                brand={brand}
                                decorative
        ...
        <section className="border-t border-neutral-200 bg-white">
          <div className="container mx-auto grid gap-10 px-4 py-16 md:grid-cols-[minmax(0,_320px)_1fr] md:px-6 lg:py-24">
            ...
            <div className="space-y-6 text-base text-neutral-600 sm:text-lg">
              ...
              <p>
                When you partner with Prism, you’re not just getting setup help.
                You’re getting a team that knows how to make Google work for
                your business.
              </p>
        ...
        <section className="border-t border-neutral-200 bg-neutral-950">
          <div className="container mx-auto flex flex-col items-center gap-6 px-4 py-16 text-center text-white md:px-6 md:py-24">
            <h2 className="text-3xl font-semibold md:text-4xl">
              Let’s build your business on Google.
            </h2>
            <p className="max-w-2xl text-base text-white/80 sm:text-lg">
              Whether you’re setting up your first business email or scaling a
              multi-location brand, we’ll help you get the most out of Google’s
              tools and ecosystem.
            </p>
