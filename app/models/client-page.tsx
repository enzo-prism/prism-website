...
const offerHighlights = [
  ...
  },
  {
    ...
    description:
      'work with prism’s creative team on real projects for local dental brands.',
  },
  {
    icon: '💵',
    title: 'paid shoots',
    description:
      'get compensated for your time and receive professional content for your own portfolio.',
  },
  {
    icon: '📅',
...
const howItWorks = [
  ...
  },
  {
    ...
    title: 'get approved',
    description:
      'if you’re a good fit, we’ll add you to the prism models list.',
  },
  {
    icon: '3',
    title: 'choose your session',
    description:
      'view available whitening appointments and pick one that fits your schedule.',
  },
  {
    icon: '4',
    title: 'whitening day',
    description:
      'attend your appointment and enjoy your professional teeth whitening.',
  },
  {
    icon: '5',
    title: 'get paid',
  ...
  },
  {
    ...
    description:
      'check the list again whenever you’re ready for your next whitening.',
  },
]
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white text-neutral-900">
      ...
      <main className="flex-1">
        ...
        <section
          className="border-b border-neutral-200 bg-neutral-50 py-14 sm:py-20"
          id="offer"
        >
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center">
              <h2 className="text-3xl font-semibold lowercase sm:text-4xl">
                why join prism models
              </h2>
            </div>
            <div className="mt-10 grid gap-5 sm:mt-12 sm:gap-6 md:grid-cols-2 md:gap-8">
              {offerHighlights.map((highlight) => (
                ...
                >
                  <div
                    className="inline-flex h-12 w-12 items-center justify-center rounded-2xl border border-neutral-200 bg-neutral-50"
                    aria-hidden="true"
                  >
                    <PixelishImg
                      src={pixelishForEmoji(highlight.icon).src}
                      alt=""
                      size={26}
                      invert={false}
                      aria-hidden="true"
                  ...
                  <p className="mt-2 text-sm text-neutral-600 sm:mt-3">
                    {highlight.description}
                  </p>
                  {highlight.note ? (
                    <p className="mt-auto pt-4 text-xs lowercase text-neutral-400">
                      {highlight.note}
                    </p>
                  ) : null}
                </div>
                ...
                >
                  ...
                  <div className="relative flex h-full flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      <h3 className="text-lg font-semibold lowercase text-neutral-900 sm:text-xl">
                        {step.title}
                      </h3>
            ...
            <div className="mt-10 flex justify-center">
              ...
              >
                <Link
                  href="#apply"
                  onClick={() =>
                    trackCTAClick('models_how_it_works_apply', '#apply')
                  }
                >
                  → apply today
                </Link>
              ...
              >
                    ...
                    <fieldset className="rounded-3xl border border-neutral-200 bg-neutral-50 p-5 sm:p-6">
                      ...
                      <div className="mt-6 space-y-4">
                        {contactMethod === 'email' ? (
                          <div className="flex flex-col gap-2">
                            <label
                              htmlFor="models-email"
                              className="text-xs font-medium lowercase text-neutral-600"
                            >
                              email address
                            </label>
                            <Input
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
                  ...
                  <p className="text-xs text-neutral-500 sm:max-w-xs">
                    we review all applications and reach out when there’s a
                    great match in your area.
                  </p>
                </div>
              </form>
            </div>
            ...
            <div className="flex flex-col gap-6 rounded-3xl border border-neutral-200 bg-neutral-900 px-6 py-8 text-white shadow-sm sm:px-8 sm:py-10 md:flex-row md:items-center md:justify-between">
              ...
              >
                <Link
                  href="/services"
                  onClick={() =>
                    trackCTAClick('dental_cta_models_footer', '/services')
                  }
                >
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-3 max-w-2xl text-sm text-neutral-300">
                join prism models for free whitening, professional photos, and
                paid creative work that helps dental practices share authentic
                stories.
              </p>
              <Button
                asChild
              ...
              >
                <Link
                  href="#apply"
                  onClick={() => trackCTAClick('models_footer_apply', '#apply')}
                >
                  → apply now
                </Link>
              </Button>
      ...
      <div className="relative">
        <div className="container mx-auto flex min-h-[60vh] flex-col justify-center gap-8 px-4 py-16 sm:gap-12 sm:py-20 md:px-6">
          <div className="max-w-3xl space-y-5 sm:space-y-6">
            <h1 className="text-3xl font-semibold lowercase text-neutral-900 sm:text-5xl">
              prism models
            </h1>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              >
                <Link
                  href="#apply"
                  onClick={() => trackCTAClick('models_hero_apply', '#apply')}
                >
                  → apply now
                </Link>
              </Button>
