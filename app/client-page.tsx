...
const SECTION_SPACING_COMPACT = 'py-12 sm:py-16 lg:py-20'
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1" id="main-content" tabIndex={-1}>
            ...
            <div className="mx-auto grid w-full max-w-6xl items-center gap-8 lg:grid-cols-[minmax(0,560px)_minmax(0,1fr)] lg:gap-10">
              ...
              <div className="space-y-4 text-center lg:text-left">
                ...
                <p className="text-balance text-base text-muted-foreground sm:text-lg">
                  ...
                  into one coordinated system so every customer touchpoint
          ...
          <div className="container relative mx-auto px-4 sm:px-6">
            <div className="space-y-3 text-center">
              ...
              <p className="text-base text-muted-foreground sm:text-lg">
                We&apos;ve implemented this same strategy for 20+ businesses,
        ...
        <section
          className={`relative ${SECTION_SPACING_COMPACT} bg-background`}
        >
            ...
            <div className="flex flex-col items-center gap-3 text-center">
              ...
              <div className="space-y-3">
                ...
                <p className="text-balance text-base text-muted-foreground">
                  Free software to help you increase leads, conversions, and
                  customer LTV
                </p>
              </div>
            </div>
        ...
        <section
          className={`relative overflow-hidden ${SECTION_SPACING_DEFAULT} bg-muted/30`}
        >
          <div className="container relative flex flex-col mx-auto gap-10 px-4 sm:px-6">
            <div className="flex flex-col items-center gap-3 text-center">
              <Badge variant="secondary" className="w-fit">
              ...
              <div className="space-y-3">
                ...
                <p className="text-balance text-base text-muted-foreground">
                  Videos, Guides, Templates, Downloads &amp; more to help you
                  succeed:
                </p>
              </div>
            </div>
          ...
          <div className="container relative mx-auto px-4 sm:px-6">
            <Card className="overflow-hidden border-border/60 bg-card/90">
              ...
              <CardFooter>
                ...
                >
                  <Link href="/about">
                    Learn more about the Founder's Story
                  </Link>
                </Button>
              </CardFooter>
            </Card>
        ...
        <section
          className={`relative overflow-hidden ${SECTION_SPACING_DEFAULT} bg-background`}
        >
                ...
                <div className="space-y-6 px-6 pb-8 pt-8 sm:px-10 sm:pt-10">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-base text-muted-foreground">
                      A clear sequence of the moves Prism makes to grow
                      visibility, conversions, and lifetime value.
                    </p>
                  </div>
                ...
                <div className="border-t border-border/60 bg-muted/30 px-6 py-8 sm:px-10 lg:border-t-0 lg:border-l">
                  <div className="space-y-5">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        One email with the full framework and the steps to
                        execute it.
                      </p>
                    </div>
                    <HomeScalingRoadmapForm />
