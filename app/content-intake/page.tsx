...
const PAGE_TITLE = 'Start your content'
const PAGE_DESCRIPTION =
  'Answer four short questions so Prism can plan your content system.'
const CANONICAL_URL = 'https://www.design-prism.com/content-intake'
    ...
    <div className="min-h-screen bg-black font-sans text-[#F5F0E8]">
      <header className="mx-auto flex w-full max-w-[1040px] items-center justify-between px-4 py-5 sm:px-6 sm:py-6">
        <TrackedLink
          href="/"
          label="prism home"
          location="content intake minimal header"
      ...
      >
        <WebsiteIntakeForm service="content" />
      </main>
