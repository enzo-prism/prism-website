...
const PAGE_TITLE = 'Start your ads'
const PAGE_DESCRIPTION =
  'Answer four short questions so Prism can scope your ad campaigns.'
const CANONICAL_URL = 'https://www.design-prism.com/ads-intake'
...
export default function AdsIntakePage() {
  return (
    <div className="min-h-screen bg-black font-sans text-[#F5F0E8]">
      <header className="mx-auto flex w-full max-w-[1040px] items-center justify-between px-4 py-5 sm:px-6 sm:py-6">
        <TrackedLink
          href="/"
          label="prism home"
          location="ads intake minimal header"
