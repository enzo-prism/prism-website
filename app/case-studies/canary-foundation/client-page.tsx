...
const quickFacts = [
  ...
  { label: "client", value: "Canary Foundation" },
...
const share = {
  ...
  title: "Canary Foundation × prism case study (coming soon)",
  description: "full case study in progress with verified implementation details and outcomes.",
}

const schema = {
  title: "Canary Foundation — case study coming soon",
  description: "full case study in progress with verified implementation details and outcomes.",
  url: "https://www.design-prism.com/case-studies/canary-foundation",
...
export default function CanaryFoundationCaseStudy() {
  return (
    <MinimalCaseStudyPage
      ...
      heroTitle="Canary Foundation — case study coming soon"
