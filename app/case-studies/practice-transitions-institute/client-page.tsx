...
const quickFacts = [
  ...
  { label: "client", value: "Practice Transitions Institute" },
...
const share = {
  ...
  title: "Practice Transitions Institute × prism case study (coming soon)",
  description: "full case study in progress with verified implementation details and outcomes.",
}

const schema = {
  title: "Practice Transitions Institute — case study coming soon",
  description: "full case study in progress with verified implementation details and outcomes.",
  url: "https://www.design-prism.com/case-studies/practice-transitions-institute",
...
export default function PracticeTransitionsInstituteCaseStudy() {
  return (
    <MinimalCaseStudyPage
      ...
      heroTitle="Practice Transitions Institute — case study coming soon"
