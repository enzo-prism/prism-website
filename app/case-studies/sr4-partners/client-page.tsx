...
const quickFacts = [
  ...
  { label: "client", value: "SR4 Partners" },
...
export default function Sr4PartnersCaseStudy() {
  return (
    <MinimalCaseStudyPage
      ...
      heroTitle="SR4 Partners — case study coming soon"
