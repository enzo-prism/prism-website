...
const logoUsageDetails: LogoUsageDetail[] = [
  {
    ...
    sections: [
      ...
      },
      {
        label: 'Impact',
        bullets: [
          'Builds immediate trust. Patients decide “is this legit?” in 3 seconds.',
        ],
      },
      {
        label: 'Footer',
  ...
  },
  {
    ...
    description:
      'Any profile where patients compare providers should match the brand.',
    icon: Globe,
    sections: [
      {
        label: 'Standards',
      ...
      },
      {
        label: 'Impact',
        bullets: [
          'Brand consistency builds trust and moves more appointment requests.',
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        bullets: [
          'Front: icon + wordmark',
          'Back: clear contact info, keep it minimal',
        ],
      },
      {
        label: 'Impact',
  ...
  },
  {
    ...
    description:
      'This is where the barn artwork aesthetic becomes a strategic asset.',
    icon: Brush,
    sections: [
      {
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          'SVG or PNG assets',
          'Use brand colors for dividers or accents',
        ],
      },
      {
        label: 'Impact',
        bullets: [
          'Referring dentists and patients see a consistent, high-level identity.',
        ],
      },
    ],
  },
  {
    ...
    description:
      'Even if usage is light, the visuals should match the website.',
    icon: Share2,
    sections: [
      {
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          'Before/after scan printouts',
        ],
      },
      {
        label: 'Impact',
        bullets: [
          'Branding here communicates competence more than anywhere else.',
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        label: 'Impact',
        bullets: [
          'Patients instantly know they’re in the right place, reducing anxiety.',
        ],
      },
    ],
  },
    ...
    try {
      const response = await fetch('https://formspree.io/f/mldayroq', {
        ...
        body: JSON.stringify({
          ...
          notes,
          ...getFormspreeOpsMetadata('wine_country_root_canal'),
        }),
      })
          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              ...
              <div className="relative overflow-hidden rounded-[28px] border border-neutral-200 bg-neutral-900 shadow-2xl shadow-black/20">
                ...
                />
                <div
                  className="absolute inset-0 bg-gradient-to-t from-neutral-950/80 via-transparent to-transparent"
                  aria-hidden
                />
              </div>
            </div>
              ...
              {logoConcepts.map((concept) => {
                const frameBg =
                  concept.variant === 'dark'
                    ...
                    : 'bg-neutral-50'
                const copyColor =
                  concept.variant === 'dark' ? 'text-white' : 'text-neutral-900'
                ...
                return (
                  ...
                  >
                    <div
                      className={`relative overflow-hidden rounded-2xl border ${frameBorder} ${frameBg}`}
                    >
                    ...
                    <h3 className={`mt-4 text-xl font-semibold ${copyColor}`}>
                      {concept.title}
                    </h3>
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-2">
                              {section.icon ? (
                                <section.icon
                                  className={`h-4 w-4 ${descriptionColor}`}
                                  aria-hidden
                                />
                              ) : null}
                              <p
                                className={`text-xs font-semibold uppercase tracking-[0.3em] ${copyColor}`}
                              >
                                {section.heading}
                              </p>
                            </div>
                            ...
                            {section.bullets && (
                              <ul
                                className={`list-disc space-y-1 pl-4 text-sm leading-relaxed ${descriptionColor}`}
                              >
                            ...
                            {section.subsections?.map((subsection) => (
                              <div
                                key={`${section.heading}-${subsection.label}`}
                                className="space-y-1"
                              >
                                <div className="flex items-center gap-2">
                                  {subsection.icon ? (
        ...
        <section className="bg-neutral-50 px-4 py-16">
          <div className="mx-auto max-w-6xl space-y-10">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl font-semibold text-neutral-900">
                where the logo should live
              </h2>
              <p className="text-sm text-neutral-600">
                Below is a complete breakdown of where the logo should appear,
                why it matters, and what format each placement needs.
              </p>
            </div>
            <div className="grid gap-6 md:grid-cols-2">
                ...
                >
                  ...
                  <div className="space-y-3">
                    {detail.sections.map((section) => (
                      <div
                        key={`${detail.title}-${section.label}`}
                        className="space-y-1"
                      >
      ...
      <Dialog open={isVoteOpen} onOpenChange={handleDialogChange}>
        <DialogContent className="max-w-2xl">
          <DialogHeader className="mb-4">
            ...
            <DialogDescription>
              Choose your favorite concept and drop notes for the creative team.
            </DialogDescription>
          </DialogHeader>
          {voteStatus === 'success' ? (
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm text-neutral-600">
                We’ll review your notes and follow up with revised directions.
                Feel free to share more context anytime.
              </p>
