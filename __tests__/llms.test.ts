...
describe("llms.txt", () => {
  it("references canonical on-site URLs and avoids noindex or off-site detours", () => {
    ...
    expect(llms).toContain("https://www.design-prism.com/dental-website")
    expect(llms).toContain("https://www.design-prism.com/ai-agents/dental")
    expect(llms).toContain("https://www.design-prism.com/blog/dental-seo-guide")
