...
jest.mock('@/utils/analytics', () => ({
  ...
  trackLeadConversion: (...args: Array<unknown>) =>
    trackLeadConversion(...args),
}))
...
describe('ApplySuccessTracker', () => {
  ...
  it('does not emit success or generate_lead when the thank-you page is revisited without pending context', async () => {
    ...
    await waitFor(() => {
      expect(consumePendingApplyLeadContext).toHaveBeenCalledTimes(1)
    })
