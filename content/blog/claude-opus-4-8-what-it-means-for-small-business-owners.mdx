...
openGraph:
  ...
  locale: en_US
  type: article
  publishedTime: "2026-05-29T15:00:00.000Z"
  authors:
    - Enzo Sison
twitter:
...
<VideoObjectSchema
  ...
  uploadDate="2026-05-29T15:00:00.000Z"
...
<figure className="my-8">
  <img
    src="/blog/opus-4-8-benchmarks-anthropic.png"
    alt="Anthropic's official Claude Opus 4.8 benchmark table comparing Opus 4.8, Opus 4.7, GPT-5.5, and Gemini 3.1 Pro across agentic coding (SWE-Bench Pro), terminal coding, reasoning (Humanity's Last Exam), computer use (OSWorld-Verified), knowledge work (GDPval-AA), and financial analysis."
    width="2600"
    height="1392"
    loading="lazy"
  ...
  <figcaption className="mt-3 text-sm text-neutral-500 dark:text-neutral-400">
    Opus 4.8 vs. Opus 4.7, GPT‑5.5, and Gemini 3.1 Pro on Anthropic's published benchmarks. Source: <a href="https://www.anthropic.com/news/claude-opus-4-8">Anthropic — Introducing Claude Opus 4.8</a>.
  </figcaption>
</figure>
