...
<h2 className="text-2xl font-bold mt-10 mb-6">why a good website matters:</h2>
<p className="mb-4">Attracts new customers: people search online for products and services. your website is your online storefront.</p>
<p className="mb-4">Builds trust: a professional website makes your business look credible.</p>
<p className="mb-4">Generates leads: it can capture contact information from potential customers.</p>
<p className="mb-4">Works 24/7: your website is always available to provide information and collect leads, even when you're not working.</p>

<p className="mb-6">let's get started! here's your step-by-step guide:</p>

<hr className="my-8" />
<h2 className="text-2xl font-bold mt-10 mb-6">phase 1: planning your website</h2>

<h3 className="text-xl font-semibold mt-6 mb-4">step 1: define your website's goal.</h3>
<p className="mb-6">what do you want visitors to do? examples:</p>
<p className="mb-4">call you for a quote?</p>
<p className="mb-4">fill out a contact form?</p>
<p className="mb-4">buy a product?</p>
<p className="mb-4">sign up for your newsletter?</p>
<p className="mb-6">
keep it focused. one or two main goals are best for a new website. this will be key to getting more
leads.
</p>

<h3 className="text-xl font-semibold mt-6 mb-4">step 2: know your audience.</h3>
<p className="mb-4">
who are your ideal customers? (e.g., local homeowners, young professionals, other businesses)
</p>
<p className="mb-4">what are their needs or problems that your business solves?</p>
<p className="mb-6">speak their language on your website.</p>

<h3 className="text-xl font-semibold mt-6 mb-4">step 3: outline your key pages.</h3>
<p className="mb-6">most business websites need at least these:</p>
<p className="mb-4">homepage: the first impression. clearly state what you do and who you help.</p>
<p className="mb-4">about us: tell your story and build trust.</p>
<p className="mb-4">services/products: detail what you offer.</p>
<p className="mb-4">contact us: make it easy for people to reach you (phone, email, form).</p>
<p className="mb-4">(optional but recommended): testimonials/reviews, blog.</p>

<h3 className="text-xl font-semibold mt-6 mb-4">step 4: gather your content.</h3>
<p className="mb-4">
...
<p className="mb-4">your logo: if you have one, get it ready.</p>

<hr className="my-8" />
<h2 className="text-2xl font-bold mt-10 mb-6">phase 2: building your website with replit</h2>
<p className="mb-6">
...
<h3 className="text-xl font-semibold mt-6 mb-4">step 1: sign up for replit.</h3>
<p className="mb-6">go to replit.com and create a free account.</p>

<h3 className="text-xl font-semibold mt-6 mb-4">step 2: find a suitable template or starting point.</h3>
<p className="mb-6">
...
<p className="mb-6">look for "ai" or "ghostwriter" (replit's ai feature) prompts within the replit interface.</p>

<h3 className="text-xl font-semibold mt-6 mb-4">step 3: customize your chosen template.</h3>
<p className="mb-4">
replace placeholder text: add your own business name, headlines, service descriptions, and contact
information.
</p>
<p className="mb-4">add your images: upload your photos and logo.</p>
<p className="mb-4">
...
<h3 className="text-xl font-semibold mt-6 mb-4">step 4: create your key pages.</h3>
<p className="mb-6">
...
<h3 className="text-xl font-semibold mt-6 mb-4">step 5: add a contact form (crucial for leads!).</h3>
<p className="mb-6">this is how visitors can easily send you their information.</p>
<p className="mb-6">
...
<h3 className="text-xl font-semibold mt-6 mb-4">step 6: make sure it's mobile-friendly.</h3>
<p className="mb-6">
...
<p className="mb-6">use replit's preview feature to see how your site looks on a simulated phone screen.</p>

<h3 className="text-xl font-semibold mt-6 mb-4">step 7: basic search engine optimization (seo).</h3>
<p className="mb-6">seo helps people find your site on google. here are simple starting points:</p>
<p className="mb-4">
...
<hr className="my-8" />
<h2 className="text-2xl font-bold mt-10 mb-6">phase 3: launching and improving your website</h3>

<h3 className="text-xl font-semibold mt-6 mb-4">step 1: test everything.</h3>
<p className="mb-4">click every link.</p>
<p className="mb-4">submit your contact form to make sure you receive the messages.</p>
<p className="mb-4">check how it looks on different devices (desktop, phone, tablet).</p>
<p className="mb-4">ask a friend to look at it and give you feedback.</p>

<h3 className="text-xl font-semibold mt-6 mb-4">step 2: "deploy" your website (make it live).</h3>
<p className="mb-6">
...
<h3 className="text-xl font-semibold mt-6 mb-4">step 3: promote your new website.</h3>
<p className="mb-4">
...
<p className="mb-4">tell your existing customers about it.</p>

<h3 className="text-xl font-semibold mt-6 mb-4">step 4: monitor and update (lead conversion focus).</h3>
<p className="mb-4">track your leads: how many inquiries are you getting through the website?</p>
<p className="mb-4">ask for feedback: when new customers contact you, ask how they found you.</p>
<p className="mb-4">
...
<hr className="my-8" />
<h2 className="text-2xl font-bold mt-10 mb-6">how ai can help (even if you're not an expert):</h2>
<p className="mb-4">
...
<hr className="my-8" />
<h2 className="text-2xl font-bold mt-10 mb-6">key takeaways for more leads:</h2>
<p className="mb-4">clear call to action: tell visitors exactly what you want them to do.</p>
<p className="mb-4">easy contact: make your phone number, email, and contact form highly visible.</p>
<p className="mb-4">mobile-friendly: essential for today's users.</p>
<p className="mb-4">trust builders: testimonials, professional design, and clear information build confidence.</p>
<p className="mb-4">
