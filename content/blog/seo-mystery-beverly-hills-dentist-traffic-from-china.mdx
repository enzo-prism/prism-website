...
openGraph:
  title: "the seo mystery: why a beverly hills dentist was getting traffic from china (and what we did about it)"
  description: "ga showed a beverly hills dentist getting most traffic from china. here’s the 3-tool workflow we used to find old backlink spam and fix it."
  url: "https://www.design-prism.com/blog/seo-mystery-beverly-hills-dentist-traffic-from-china"
  siteName: "Prism"
  type: "article"
...
twitter:
  ...
  description: "a fast, practical workflow to diagnose weird geo traffic, uncover spam backlinks, and clean up seo baggage."
canonical: "https://www.design-prism.com/blog/seo-mystery-beverly-hills-dentist-traffic-from-china"
