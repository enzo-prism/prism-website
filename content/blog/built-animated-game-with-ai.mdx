...
description: >-
  a first-hand account of building a cookie clicker clone with claude code and
  what it reveals about agentic software development.
date: '2025-06-10'
...
openGraph:
  ...
  description: >-
    a first-hand account of building a cookie clicker clone with claude code and
    what it reveals about agentic software development.
  url: 'https://www.design-prism.com/blog/built-animated-game-with-ai'
  siteName: prism
  images:
    - url: /blog/claude-code-game-dev.png
      ...
      height: 630
      alt: >-
        An illustration of an AI coding assistant building a game on a computer
        screen.
  locale: en_US
  type: article
...
twitter:
  ...
  description: >-
    i built a cookie clicker clone with claude code ai. here's what it shows
    about the future of agentic software development.
  images:
    - /blog/claude-code-game-dev.png
canonical: 'https://www.design-prism.com/blog/built-animated-game-with-ai'
seoTitle: "I built an animated game with AI"
seoDescription: "A first-hand account of building a Cookie Clicker clone with Claude Code, and what it reveals about agentic software development."
---
...
The world of software development is in a wild, mind-blowing era. If you've been following our work at Prism, you know we're always exploring the newest tools, using tools like Replit, Vercel, and OpenAI Codex. But recently, I tried something that completely blew me away: Claude Code.
</p>
<p>
...
<h3 class="text-xl font-bold mt-8 mb-4">My First Time Using Claude Code</h3>
<p>
...
<hr class="my-8" />
<h3 class="text-xl font-bold mt-8 mb-4">The Challenge: Recreating "Cookie Clicker"</h3>
<p>
...
<hr class="my-8" />
<h3 class="text-xl font-bold mt-8 mb-4">Taking It to the Next Level with a Simple Request</h3>
<p>
...
<hr class="my-8" />
<h3 class="text-xl font-bold mt-8 mb-4">A Quick Note on Cost</h3>
<p>
...
<hr class="my-8" />
<h3 class="text-xl font-bold mt-8 mb-4">The Future is Now</h3>
<p>
