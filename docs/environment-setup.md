...
| `NEXT_PUBLIC_WEBSITE_INTAKE_FORM_ENDPOINT`           | Optional            | Formspree endpoint for the focused `/website-intake` PRO website funnel.                 | Unset: the form shows a "not configured" notice instead of submitting.                       | `components/forms/WebsiteIntakeForm.tsx`                                                                                |
