...
| `NEXT_PUBLIC_WEBSITE_INTAKE_FORM_ENDPOINT`           | Optional            | Formspree endpoint for the focused `/website-intake` PRO website funnel.                                | Defaults to the dedicated **Website Intake** form at `https://formspree.io/f/xrpzlkrd`. Keep Vercel Production + Preview aligned with this value. See [`docs/forms.md`](forms.md#formspree-dashboard-configuration).                               | `components/forms/WebsiteIntakeForm.tsx`                                                                                |
...
- `/website-intake` uses the dedicated Prism **Website Intake** form (`xrpzlkrd`), with the dashboard configuration recorded in [`docs/forms.md`](forms.md#formspree-dashboard-configuration).
