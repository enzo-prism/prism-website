...
| `NEXT_PUBLIC_WEBSITE_INTAKE_FORM_ENDPOINT`           | Optional            | Override the `/website-intake` Formspree endpoint without code changes.                  | Defaults to `https://formspree.io/f/xpqebnbz` (the existing Prism website-request form).     | `components/forms/WebsiteIntakeForm.tsx`                                                                                |
