...
- `components/global-elevenlabs-widget.tsx` is now the single public widget surface. It mounts on the homepage and inner pages alike, defaults to collapsed when there is no saved user preference, and persists later manual expand/collapse choices in browser storage.
